...
CREATE TABLE athena.VOCABULARY_CONVERSION
(  
...
CREATE TABLE athena.VOCABULARY_CATEGORIES
(
   CATEGORY_ID BIGINT,
   TITLE       VARCHAR(256),
   SORT        INTEGER
...
CREATE INDEX DRUG_CONCEPTID ON athena.DRUG_STRENGTH (DRUG_CONCEPT_ID);
CREATE INDEX INGREDIENT_CONCEPTID ON athena.DRUG_STRENGTH (INGREDIENT_CONCEPT_ID);
...
CREATE INDEX CONCEPT_RELATIONSHIP_C_1 ON athena.CONCEPT_RELATIONSHIP (CONCEPT_ID_1);
CREATE INDEX CONCEPT_RELATIONSHIP_C_2 ON athena.CONCEPT_RELATIONSHIP (CONCEPT_ID_2);
...
CREATE INDEX ANCESTOR_CONCEPTID ON athena.CONCEPT_ANCESTOR (ANCESTOR_CONCEPT_ID);
CREATE INDEX DESCENDANT_CONCEPTID ON athena.CONCEPT_ANCESTOR (DESCENDANT_CONCEPT_ID);
...
CREATE INDEX CONCEPT_VOCAB ON athena.CONCEPT (VOCABULARY_ID);