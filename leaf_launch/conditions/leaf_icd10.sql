 ...
 * Uses concept table entries from Caboodle and Athena and custom concept_relationship entries.
...
-- To enable more precise condition queries, we use custom mappings in concept_relationship from EPIC EDG to ICD-10-CM,
-- which were generated by Arthur Goldberg's conditions_I10_to_EDG.sql script.
-- Because ICD-10-CM isn't standard, MSDW2 uses a new relationship_id = 'Maps to non-standard'
...
-- Prefix of query generated by user selection; the value or range of the ICD10 code will be appended
...
(SELECT 1
 ...
 WHERE
     ...
     AND @CR.relationship_id = ''Maps to non-standard''
...
INSERT INTO LeafDB.app.Concept
    ...
    SELECT
       ...
       ,[SqlSetWhere]                  = CONCAT( @ConstantSqlSetWhere, UMLS_ICD10.SqlSetWhere, ')' )
                                                 -- Drop, which triggers https://github.com/uwrit/leaf/issues/447:
