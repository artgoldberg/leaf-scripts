...
2. update concept_relationship & condition_occurrence from leaf_scratch.conditions_map
...
-- 2. update concept_relationship & condition_occurrence from leaf_scratch.conditions_map
-- insert conditions_map SNOMED to ICD10 relationships into concept_relationship
...
FROM leaf_scratch.conditions_map conditions_map,
...
Not needed, as the ICD10 -> SNOMED relationships are already in concept_relationship
...
PRINT 'Completed update concept_relationship & condition_occurrence from leaf_scratch.conditions_map'
*/
...
FROM test_omop_conditions.condition_occurrence condition_occurrence,
     leaf_scratch.conditions_map conditions_map,
...
WHERE NOT condition_occurrence.condition_source_concept_id = 0
      ...
      AND concept_Epic.concept_code = conditions_map.Epic_concept_code
