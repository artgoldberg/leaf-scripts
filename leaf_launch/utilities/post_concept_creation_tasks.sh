...
sqlcmd -S msdw2-mssql-prd.msnyuhealth.org -U sql_svc_leaf -i ../../omop/5.3/post_concept_creation_tasks.sql >> post_concept_creation_tasks.log 2>> post_concept_creation_tasks_error.log
